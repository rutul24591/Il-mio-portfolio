      ...
      <Container>
        <Row className="about-me-row">
            ...
            <p className="about-me-text">
                Hi, I'm <span className="purple-colored-text">Rutul Amin</span> and I hail from <span className="purple-colored-text">Ahmedabad, India</span>.<br/> 
                I like to code and getting hands dirty on learning new tools and technologies. <br/>
                Apart from that I love to spend time with my family and friends. <br/>
                In my spare time I like to play on my console, read books and watch football.<br/>
                I also love to travel and read travel blogs.<br/>
            </p>
        </Row>
